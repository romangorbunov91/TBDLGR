...
1. Видеофайл раскладывается на $r_1$-кадр исходного размера ${3 \times h_1 \times w_1}$.
2. Кадры с вертикальной ориентаций 16:9 обрезаются на 20% сверху и 20% снизу, затем приводятся к размеру ${3 \times h_2 \times w_2}$. В случае вертикальных кадров это ${3 \times 360 \times 270}$. Кадры с горизонтальной ориентацией не обрезаются, но приводятся к размеру ${3 \times 270 \times 360}$.
...
5. Кадры приводятся к размеру ${3 \times 224 \times 224}$.
