...
if __name__ == "__main__":
    # Путь к видео
    video_path = '00b6a969f5d91a0c179252c471edfdbc.mp4'  # Путь к видеофайлу
    ...
    # Извлекаем 40 самых резких кадров
    sharp_frames = extract_sharpest_frames(video_path, output_folder)

    # Прогоняем каждое изображение через media_pipe и сохраняем результат
    media_pipe(sharp_frames, annotated_folder)
